...
import UserAdminInfoCard from "./cards/InformacionUsuarioCard";
import UserAdminMetaCard from "./cards/UsuarioMetaCard";
import UserAdminSecurityCard from "./cards/CambioPasswordCard";
    ...
    <>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
        ...
        <div className="space-y-6">
          ...
          <UserAdminSecurityCard user={user} setUser={setUser} setImgVersion = {setImgVersion}/>
        </div>
      </div>
    </>
  );
